...
- Node is available for JavaScript tooling.
- npm is available through `npm.cmd`; the PowerShell `npm.ps1` shim is blocked by the current script policy.
- Windows PowerShell is available.

## Tool paths verified
- Git direct executable: `C:\Program Files\Git\cmd\git.exe`
- Git version: `git version 2.55.0.windows.3`
- Node executable: `C:\Program Files\nodejs\node.exe`
- Node version: `v24.19.0`
- npm direct executable: `C:\Program Files\nodejs\npm.cmd`
- npm version: `11.17.0`
- npm PowerShell shim: `C:\Program Files\nodejs\npm.ps1` exists but is blocked by script execution policy in this shell.

## Current local files
- `HARDWARE_DECISION_TABLE.md`
- `STRONGHOLD_DAY_001.md`
